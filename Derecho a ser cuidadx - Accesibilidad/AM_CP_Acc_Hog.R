...
# 1. Cargar bases
#Bases para información sobre casas hogares privadas
...
# 3. Total
AM_CP_Acc_Hog_Comp <- (1-(prop1 + prop2 + prop3))*100
AM_CP_Acc_Hog_Comp

#Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
AM_CP_Acc_Hog_Comp <- as.data.frame(AM_CP_Acc_Hog_Comp) 
write_xlsx(AM_CP_Acc_Hog_Comp, "output/AM_CP_Acc_Hog.xlsx")

...
# 3. Indicador
AM_CP_Asq_Est <- (numerador/denominador)*100
AM_CP_Asq_Est
...
AM_CP_Asq_Est <- as.data.frame(AM_CP_Asq_Est)
write_xlsx(AM_CP_Asq_Est, "output/AM_CP_Asq_Est.xlsx")

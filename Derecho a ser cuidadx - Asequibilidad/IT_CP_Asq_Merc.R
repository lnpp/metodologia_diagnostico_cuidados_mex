...
# Propósito de IT_CP_Asq_Merc:
# Calcular el indicador de asequibilidad de cuidados personales
# de infancia temprana desde el mercado
...
menores5_priv <- menores5[menores5$p23==12 & menores5$p25!=0,]
...
denominador <- sum(menores5_priv$factor, na.rm = TRUE) #Total de menores de 5 cuidados por una persona remunerada, con información de ingresos mensuales
...
IT_CP_Asq_Merc <- (numerador/denominador)*100
IT_CP_Asq_Merc

# 4. Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
IT_CP_Asq_Merc <- as_data_frame(IT_CP_Asq_Merc)
write_xlsx(IT_CP_Asq_Merc, "output/IT_CP_Asq_Merc.xlsx")

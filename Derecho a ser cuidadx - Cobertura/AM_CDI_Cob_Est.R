...
AM_CDI_Cob_Est <- (numerador/denominador)*100
AM_CDI_Cob_Est

#Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
AM_CDI_Cob_Est <- as.data.frame(AM_CDI_Cob_Est) 
write_xlsx(AM_CDI_Cob_Est, "output/AM_CDI_Cob_Est.xlsx")

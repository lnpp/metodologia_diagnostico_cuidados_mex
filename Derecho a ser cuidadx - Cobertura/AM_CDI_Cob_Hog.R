...
# 3. Total
AM_CDI_Cob_Hog_Comp <- (1-(prop1 + prop2 + prop3))*100
AM_CDI_Cob_Hog_Comp

#Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
AM_CDI_Cob_Hog_Comp <- as.data.frame(AM_CDI_Cob_Hog_Comp) 
write_xlsx(AM_CDI_Cob_Hog_Comp, "output/AM_CDI_Cob_Hog.xlsx")

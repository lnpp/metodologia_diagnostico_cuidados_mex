...
# 3. Total
AM_CDI_Cob_Merc <- (prop1 + prop2)*100
AM_CDI_Cob_Merc

#Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
AM_CDI_Cob_Merc <- as.data.frame(AM_CDI_Cob_Merc) 
write_xlsx(AM_CDI_Cob_Merc, "output/AM_CDI_Cob_Merc.xlsx")

...
# 3. Total
AM_CP_Cob_Merc <- (prop1 + prop2)*100
AM_CP_Cob_Merc

#Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
AM_CP_Cob_Merc <- as.data.frame(AM_CP_Cob_Merc) 
write_xlsx(AM_CP_Cob_Merc, "output/AM_CP_Cob_Merc.xlsx")

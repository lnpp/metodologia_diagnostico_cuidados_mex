...
AM_CS_Cob_Est <- (numerador/denominador)*100
AM_CS_Cob_Est

# 4. Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
AM_CS_Cob_Est <- as.data.frame(AM_CS_Cob_Est) 
write_xlsx(AM_CS_Cob_Est, "output/AM_CS_Cob_Est.xlsx")

...
IT_CS_Cob_Merc <- (numerador/denominador)*100
IT_CS_Cob_Merc

# 4. Guardar el resultado del indicador en la carpeta de output (como archivo .xlsx de Excel)
IT_CS_Cob_Merc <- as.data.frame(IT_CS_Cob_Merc) 
write_xlsx(IT_CS_Cob_Merc, "output/IT_CS_Cob_Merc.xlsx")
